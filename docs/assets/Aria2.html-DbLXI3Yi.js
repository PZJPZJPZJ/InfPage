import{_ as n,c as a,e as i,o as l}from"./app-G2O8SSYQ.js";const e={};function c(d,s){return l(),a("div",null,s[0]||(s[0]=[i(`<h1 id="aria2-开源下载工具" tabindex="-1"><a class="header-anchor" href="#aria2-开源下载工具"><span>Aria2:开源下载工具</span></a></h1><h2 id="仓库地址" tabindex="-1"><a class="header-anchor" href="#仓库地址"><span>仓库地址</span></a></h2><ul><li><a href="https://github.com/aria2/aria2" target="_blank" rel="noopener noreferrer">Aira2</a></li><li><a href="https://github.com/mayswind/AriaNg" target="_blank" rel="noopener noreferrer">AriaNg</a></li></ul><h2 id="使用方法" tabindex="-1"><a class="header-anchor" href="#使用方法"><span>使用方法</span></a></h2><ol><li>在软件根目录创建并配置aria2.conf文件</li><li>在软件根目录创建空白aria2.session文件</li><li>使用命令运行该程序</li><li>打开AriaNg运行浏览器图形界面</li></ol><h2 id="运行命令" tabindex="-1"><a class="header-anchor" href="#运行命令"><span>运行命令</span></a></h2><div class="language-bat line-numbers-mode" data-highlighter="prismjs" data-ext="bat"><pre><code class="language-bat"><span class="line">aria2c.exe --conf-path=aria2.conf</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="配置文件" tabindex="-1"><a class="header-anchor" href="#配置文件"><span>配置文件</span></a></h2><div class="language-conf line-numbers-mode" data-highlighter="prismjs" data-ext="conf"><pre><code class="language-conf"><span class="line">## &#39;#&#39;开头为注释内容, 选项都有相应的注释说明, 根据需要修改 ##</span>
